                ...
                <div class="header-setting">
                    <div class="module-setting">
                        <div class="mysetting language-switcher">
                            <div class="tongle">
                                <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/flag/english.png');?>">
                                <span>English</span>
                            </div>
                            <div class="content">
                                <div class="language-switcher">
                                    <ul id="select-language">
                                        ...
                                        <li>
                                            <a href="index2.html">
                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/flag/brazil.png');?>">
                                            <span>Brazil</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a href="index3.html">
                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/flag/france.png');?>">
                                            <span>France</span>
                                            </a>
                                        </li>
                                        <li>
                                            <a class="selected" href="index4.html">
                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/flag/russian.png');?>">
                                            <span>Russian</span>
                                            </a>
                                        </li>
                                    </ul>
                ...
                <div class="row">
                    <h1 id="logo" class="responsv col-md-3">
                        <a href="index4.html" title="Magento Commerce">
                         <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/logo.jpg')?>"> 
                        </a>
                    </h1>
                    ...
                    <div id="sns_custommenu" class="visible-md visible-lg">
                        <ul class="mainnav">
                            <li class="level0 custom-item active">
                                <a class="menu-title-lv0 pd-menu116" href="index4.html" target="_self">
                            ...
                            <li class="level0 custom-item">
                                <a class="menu-title-lv0" href="index4-blog.html">
                                    <span class="title">Blog</span>
                                </a>
                            </li>
                            <li class="level0 custom-item">
                                <a class="menu-title-lv0" href="index4-contact-us.html">
                                    <span class="title">Contact Us</span>
                                </a>
                            </li>
                            <li class="level0 custom-item rsnone">
                                <a class="menu-title-lv0" href="#">
                            ...
                            <ul class="mainnav">
                                <li class="level0 custom-item">
                                    <div class="accr_header">
                                        <a class="menu-title-lv0" href="index4.html">
                                            <span class="title">Home</span>
                                        </a>
                                    </div>
                                </li>
                                ...
                                <li class="level0 nav-5 first">
                                    <div class="accr_header">
                                        <a class=" menu-title-lv0" href="index4-listing-grid.html">
                                    ...
                                    <div class="block-content content">
                                        <div class="block-inner">
                                            <ol id="cart-sidebar" class="mini-products-list">
                                                <li class="item odd">
                                                    <a class="product-image" title="Modular Modern" href="index4-detail.html">
                                                        <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/1.jpg')?>">
                                                    </a>
                                                    <div class="product-details">
                                                        ...
                                                        <p class="product-name">
                                                            <a href="index4-detail.html">Modular Modern</a>
                                                        </p>
                                                        <!-- <strong>1</strong>
                                                        x -->
                                                ...
                                                <li class="item odd">
                                                    <a class="product-image" title="Modular Modern" href="index4-detail.html">
                                                        <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/22.jpg')?>">
                                                    </a>
                                                    <div class="product-details">
                                                        <a class="btn-remove" onclick="return confirm('Are you sure you would like to remove this item from the shopping cart?');" title="Remove This Item" href="#">Remove This Item</a>
                                                        <a class="btn-edit" title="Edit item" href="#">Edit item</a>
                                                ...
                                                <li class="item last even">
                                                    ...
                                                    <div class="product-details">
                                                        <a class="btn-remove" onclick="return confirm('Are you sure you would like to remove this item from the shopping cart?');" title="Remove This Item" href="#">Remove This Item</a>
                                                        <a class="btn-edit" title="Edit item" href="index4-detail.html">Edit item</a>
                                                        <p class="product-name">
                                            ...
                                            <div class="actions">
                                                ...
                                                <a class="button gfont go-to-cart" href="index4-shoppingcart.html">Go to cart</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
