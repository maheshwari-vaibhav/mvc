                ...
                <div id="partners_slider1" class="our_partners owl-carousel owl-theme owl-loaded" style="display: inline-block">
                    <div class="item">
                        <a class="banner11" href="#" target="_blank">
                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/brands/1.png');?>">
                        </a>
                    </div>
                    <div class="item">
                        <a class="banner11" href="#" target="_blank">
                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/brands/2.png');?>">
                        </a>
                    </div>
                    <div class="item">
                        <a class="banner11" href="#" target="_blank">
                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/brands/3.png');?>">
                        </a>
                    </div>
                    <div class="item">
                        <a class="banner11" href="#" target="_blank">
                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/brands/4.png');?>">
                        </a>
                    </div>
                    <div class="item">
                        <a class="banner11" href="#" target="_blank">
                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/brands/5.png');?>">
                        </a>
                    </div>
                    <div class="item">
                        <a class="banner11" href="#" target="_blank">
                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/brands/6.png');?>">
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="bottom-pd2 col-sm-6">
                    <div class="payment">
                        <img src="customer/images/sns_paymal.png" alt="">
                    </div>
                </div>
            </div>
        </div>
...
<!-- Scripts -->
<script src="<?php echo $this->baseUrl('skin/customer/js/jquery-1.9.1.min.js')?>"></script>
<script src="<?php echo $this->baseUrl('skin/customer/bootstrap/js/bootstrap.min.js')?>"></script>
<script src="<?php echo $this->baseUrl('skin/customer/js/less.min.js')?>"></script>
<script src="<?php echo $this->baseUrl('skin/customer/js/owl-carousel/owl.carousel.min.js')?>"></script>
<script src="<?php echo $this->baseUrl('skin/customer/js/sns-extend.js')?>"></script>
