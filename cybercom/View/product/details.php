                            ...
                            <div class="row row-img">
                                ...
                                <div class="product-img-box col-md-4 col-sm-5">
                                    <div class="detail-img">
                                        <img src="<?php echo $this->baseUrl('skin/customer/images/products/13.jpg');?>" alt="">
                                    </div>
                                    <div class="small-img">
                                        <div id="sns_thumbail" class="owl-carousel owl-theme">
                                            <div class="item">
                                                <img src="<?php echo $this->baseUrl('skin/customer/images/products/1.jpg');?>" alt="">
                                            </div>
                                            <div class="item">
                                                <img src="<?php echo $this->baseUrl('skin/customer/images/products/2.jpg');?>" alt="">
                                            </div>
                                            <div class="item">
                                                <img src="<?php echo $this->baseUrl('skin/customer/images/products/3.jpg');?>" alt="">
                                            </div>
                                            <div class="item">
                                                <img src="<?php echo $this->baseUrl('skin/customer/images/products/4.jpg');?>" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="item-inner product_list_style">
                                        <div class="item-info">
                                            <div class="item-title">
                                                <a title="Modular Modern" href="index4-detail.html">Modular Modern</a>
                                            </div>
                ...
                <div id="sns_left" class="col-md-3">
                                            ...
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/10.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/11.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/12.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/13.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/14.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/15.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/16.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/17.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/18.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/19.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/20.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                    ...
                    <div class="block block-banner banner5">
                        <a href="#" class="banner22">
                            <img src="<?php echo $this->baseUrl('skin/customer/images/blog-banner1.jpg');?>" alt="">
                        </a>
                    </div>
                </div>
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/8.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/3.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/26.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
                                        ...
                                        <div class="item-inner">
                                            <div class="prd">
                                                <div class="item-img clearfix">
                                                    ...
                                                    <a class="product-image have-additional" href="index4-detail.html" title="Modular Modern">
                                                        <span class="img-main">
                                                            <img alt="" src="<?php echo $this->baseUrl('skin/customer/images/products/29.jpg');?>">
                                                        </span>
                                                    </a>
                                                </div>
                                                <div class="item-info">
